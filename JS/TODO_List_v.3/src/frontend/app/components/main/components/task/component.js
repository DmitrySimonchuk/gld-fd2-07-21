...
function CreatingTaskModal({
    ...
    const cardModalHeaderUser = document.createElement('div');
    ...
    cardModalHeaderUser.textContent = 'User:  ' + userId;
    ...
    cardModal.append(cardModalHeaderUser, cardModalHeader, cardModalBody);
